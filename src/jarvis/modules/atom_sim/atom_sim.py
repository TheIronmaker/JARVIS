...
class AtomSimNode:
    def __init__(self, orbital:list|dict, electron_r:int=1.5):
        self.n, self.l, self.m, self.N = orbital if type(orbital) == list else (orbital[k] for k in ("n", "l", "m", "N"))
    ...
    def set_orbitals(self, n=None, l=None, m=None, N=None, electron_r=None):
