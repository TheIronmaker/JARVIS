...
if __name__ == "__main__":
    ...
    # Create a QSurfaceFormat object to request a specific OpenGL version and profile (context)
    format: QSurfaceFormat = QSurfaceFormat()

    # Requests 4x multisampling (antialiasing)
    format.setSamples(4)

    # MacOS requires core profile for OpenGL 3.2 and up to 4.1. OpenGL will be deprecated to the METAL API backend
    ...
    # Request 24 bit-depth to help display z-depth
