...
## Step 2 - GitHub Clone
Run this command to download the `JARVIS` project:
``` Command Shell
git clone <https://JARVIS.git>
```
...
Since this project uses the MediaPipe library for image processing and tracking, it is required to use python 3.12. You can go to the python website and install python 3.12 onto your computer. The venv will be setup with this version.
...
### Initialize venv
While inside of the folder containing the venv, initialize it with this command:
```
.\venv\Scripts\activate.bat
```
Or if inside PowerShell:
```
...
pip install -e .
```
You should be able to run the main program at this point.

### Main Program Startup
Navigate to the main directory. This is found with:
```
cd src/jarvis
```
